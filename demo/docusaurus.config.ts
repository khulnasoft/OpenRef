...
const config: Config = {
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/khulnasoft/openref", // Added missing quote
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: "Keytar",
        src: "img/openref", // Added missing quote
      },
      items: [
        {
          type: "doc",
        ...
        {
          href: "https://medium.com/khulnasoft",
          position: "right",
          className: "header-medium-link",
          "aria-label": "KhulnaSoft Developer Blog",
        },
        {
          href: "https://github.com/khulnasoft/openref", // Added missing quote
          position: "right",
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} KhulnaSoft, Ltd. Built with Docusaurus ${DOCUSAURUS_VERSION}.`,
    },
    prism: {
      additionalLanguages: [
        "ruby",
      ...
      "docusaurus-plugin",
      {
        ...
        config: {
          petstore_versioned: {
            ...
            downloadUrl:
              "https://raw.githubusercontent.com/khulnasoft/openrefles/petstore.yaml",
            versions: {
              "1.0.0": {
