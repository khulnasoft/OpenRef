...
title: Overview
slug: /
image: https://docusaurus-openapi.tryingpan.dev/img/openref-logo.svg
tags:
  - documentation
  - openapi
  - getting started
...
<iframe
  src="https://ghbtns.com/github-btn.html?user=khulnasoft&amp;repo=openref&amp;type=star&amp;count=true&amp;size=large"
  width={160}
  height={30}
  title="GitHub Stars"
/>
...
Run the following to bootstrap a Docsaurus v2 site (classic theme) with `openref`:
...
See [versions options](#versions) for a list of available options. For a complete example of how to configure versining see the [demo configuration](https://github.com/khulnasoft/openref/blob/main/demo/docusaurus.config.js#L190).
